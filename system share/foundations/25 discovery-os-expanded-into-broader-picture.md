...
This means many things we find abhorrent might be technically "legal" if they don't violate these three principles. 

I guess it is useful way to see if the structure is sensible to people. Planetary law, organism agnostic (almost: worthwhile organism). Then for deeper law or structure you nest.

In particular, we must protect all children from all harm. Including sex happening to them. Including if the perpetrator against another child is a child.

To fix it *before it happens* by understanding others well and ensuring they are separated from children.
